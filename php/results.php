...
function get_playlist($pid, $uid = null)
{
	if( $uid != null )
	{	
...
// get a serarch
function get_search($artist=null, $album=null, $title=null, $genre=null, $file=null, $lyrics=null, $sortby=null, $and=null, $pid=null, $uid=null)
{
	...
	if( $uid != null )
	{
		$sql = "SELECT art.file as art_file, track, title, album, artist.artist, song.file, song.id, " . 
		"user_cart.user_id, user_cart.removed_ts FROM song " .
		"LEFT JOIN artist ON artist.id = song.artist_id " .
		"LEFT JOIN album ON album.id = song.album_id " .
		"LEFT JOIN art ON song.art_id = art.id " .
	...
	{
		$sql = "SELECT art.file as art_file, track, title, album, artist.artist, song.file, song.id FROM song " .
		"LEFT JOIN artist ON artist.id = song.artist_id " .
		"LEFT JOIN album ON album.id = song.album_id " .
		"LEFT JOIN art ON song.art_id = art.id";
	}
